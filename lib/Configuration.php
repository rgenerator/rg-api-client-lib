...
namespace RGAuth\SwaggerClient;
...
class Configuration
{
     ...
     *
     * @var \RGAuth\SwaggerClient\ApiClient
     */
     ...
     * @var string
     */
    protected $host = 'http://qb.myplaydirect.com/';
    ...
    {
        $report  = "PHP SDK (RGAuth\SwaggerClient) Debug Report:\n";
        $report .= "    OS: ".php_uname()."\n";
